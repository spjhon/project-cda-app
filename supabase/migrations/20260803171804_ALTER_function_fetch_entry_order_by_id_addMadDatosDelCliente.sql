...
RETURNS TABLE (
    ...
    -- Atributos Técnicos del Vehículo Asociado (SNAPSHOT - INMUTABLE)
    ...
    -- Snapshots de Personas
    propietario_nombre TEXT,
    propietario_documento TEXT,
    propietario_tipo_documento TEXT,
    propietario_telefono VARCHAR,   -- 🌟 NUEVO
    propietario_email TEXT,         -- 🌟 NUEVO
    propietario_direccion TEXT,     -- 🌟 NUEVO

    cliente_nombre TEXT,
    cliente_documento TEXT,
    cliente_tipo_documento TEXT,
    cliente_telefono VARCHAR,       -- 🌟 NUEVO
    cliente_email TEXT,             -- 🌟 NUEVO
    cliente_direccion TEXT,         -- 🌟 NUEVO

    funcionario_nombre TEXT,
    funcionario_documento TEXT,
    funcionario_firma TEXT,

    -- Snapshots del Director Técnico
    director_tecnico_nombre TEXT,
    director_tecnico_documento TEXT,
    director_tecnico_tipo_documento TEXT,
    director_tecnico_firma TEXT,
...
BEGIN
    ...
    SELECT 
        ...
        -- Bloque: Especificaciones del Vehículo EXTRAÍDAS DEL SNAPSHOT
        ...
        -- Bloque: Snapshots de Personas (Inclusión de contacto)
        ...
        o.propietario_telefono_snapshot AS propietario_telefono,
        ...
        o.cliente_telefono_snapshot AS cliente_telefono,
        ...
        o.director_tecnico_nombre_snapshot AS director_tecnico_nombre,
        o.director_tecnico_numero_documento_snapshot::TEXT AS director_tecnico_documento,
        o.director_tecnico_tipo_documento_snapshot::TEXT AS director_tecnico_tipo_documento,
        o.director_tecnico_firma_base64_snapshot AS director_tecnico_firma,
        ...
        -- Bloque Subconsulta 3: Firmas Dinámicas Complementarias
        (
            SELECT jsonb_agg(
                jsonb_build_object(
