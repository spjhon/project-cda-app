DROP FUNCTION IF EXISTS public.check_preventiva_reinspection_eligibility(p_placa CHARACTER VARYING, p_tenant_id UUID);

CREATE OR REPLACE FUNCTION public.check_reinspection_eligibility_table(
