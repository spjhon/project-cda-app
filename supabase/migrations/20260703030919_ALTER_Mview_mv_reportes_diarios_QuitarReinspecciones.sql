-- 1. Eliminar la vista actual (es necesario para poder cambiar su definición estructural)
DROP MATERIALIZED VIEW IF EXISTS public.mv_reportes_diarios CASCADE;

-- 2. Crear la vista materializada refinada
