...
export default async function Login({
  ...
  const testimonials = [
    {
      quote:
        "Este login posee un robusto sistema de autenticación por medio de un proxy que procesa la seguridad de cada solicitud al servidor.",
    ...
    {
      quote:
        "Si alguien mas entra con tu usuario y contraseña, te saldra un mensaje de error para darte aviso que alguien mas tiene tus credenciales.",
    ...
    {
      quote:
        "Contraseña cifrada gracias al sistema de auth de Supabase que otorga una capa obligatoria en seguridad de cuentas reales",
  ...
  return (
    <div className="flex flex-col lg:flex-row min-h-screen">
      ...
      <div className="w-full lg:w-1/2 min-h-screen flex flex-col justify-center   py-12 px-4  relative">
        ...
        <Link
          ...
          className="absolute left-8 top-[1.6rem] flex items-center text-sm hover:opacity-70 transition-colors font-medium"
        >
          ...
          <div className="space-y-6 max-w-lg">
            ...
            <div className="mt-8 text-center">
              <p className="text-primary-100 text-sm">
                Utiliza la cuenta demo o registra un email en la sección de
                registro.
              </p>
            </div>
          </div>
