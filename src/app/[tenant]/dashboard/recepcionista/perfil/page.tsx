...
export default function ReceptionistProfilePage() {
  ...
  // Skeleton de carga premium en caso de retraso en el contexto
  if (!user && !tenantData) {
    return (
  ...
  // Fecha simulada del sistema para contexto de auditoría ISO 17020
  ...
  return (
    <div className="p-6 md:p-8 space-y-8 max-w-6xl mx-auto">
      {/* ==========================================
          ANUNCIO / BANNER DE BIENVENIDA PREMIUM
         ========================================== */}
      <div className="relative overflow-hidden rounded-2xl border bg-linear-to-r from-primary/3 to-primary/1 p-6 md:p-8 shadow-xs">
        ...
        {/* Detalle decorativo geométrico de fondo */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          <Card className="border-border/60 shadow-xs">
            ...
            <CardContent className="space-y-4">
              ...
              {/* Alerta informativa de firmas (Vital para CDA / ISO 17020) */}
              <div className="flex gap-3 items-start p-3.5 rounded-xl border border-amber-500/20 bg-amber-500/2 text-amber-800 dark:text-amber-300">
                ...
                <div className="text-xs space-y-1">
                  ...
                  <p className="text-muted-foreground leading-relaxed">
                    Tu usuario está configurado para estampar tu nombre e identificación en el snapshot de las órdenes de entrada generadas. Asegúrate de reportar cualquier cambio en tu documento a la administración técnica.
                  </p>
                </div>
              </div>
            </CardContent>
          ...
          {/* TARJETA DE ESTADÍSTICAS OPERATIVAS SIMULADAS */}
        ...
        <div className="space-y-6">
          <Card className="border-border/60 shadow-xs overflow-hidden h-full">
            <div className="h-2 bg-primary" /> {/* Línea decorativa superior corporativa */}
            <CardHeader className="pb-4">
              <div className="flex items-center gap-2">
            ...
            <CardContent className="space-y-5">
              ...
              {/* Detalles Técnicos de la Empresa */}
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between text-xs py-1">
                  ...
                  <Badge variant="outline" className="text-[10px] font-semibold border-emerald-500/30 text-emerald-600 bg-emerald-500/2 tracking-wide">
                    ISO 17020
                  </Badge>
                </div>
              </div>
