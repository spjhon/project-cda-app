...
await queryClient.invalidateQueries({
  ...
  return (
    <div className="p-6 md:p-8 space-y-8 max-w-6xl mx-auto">
          ...
          <div className="flex items-center gap-5 text-center md:text-left flex-col md:flex-row">
            ...
            <div className="space-y-1.5">
              <div className="flex flex-wrap items-center justify-center md:justify-start gap-2">
                ...
                <Badge
                  variant="secondary"
                  className="bg-primary/10 text-primary border-primary/10 font-medium capitalize"
                >
                  Director Tecnico
                </Badge>
              </div>
              <p className="text-sm text-muted-foreground max-w-md">
                Gestionando el control de acceso y documentación técnica
                vehicular con cumplimiento normativo.
              </p>
            </div>
          </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          <Card className="border-border/60 shadow-xs">
            <CardHeader className="pb-4">
              ...
              <CardDescription>
                Datos de identidad registrados en la plataforma centralizada del
                CDA.
              </CardDescription>
            </CardHeader>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="flex items-start gap-3 p-3 rounded-lg border border-border/40 bg-muted/15">
                  ...
                  <div className="space-y-0.5">
                    ...
                    <p className="text-xs font-mono text-foreground tracking-tight truncate">
                      {user?.id || "N/A"}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3 rounded-lg border border-border/40 bg-muted/15">
                  ...
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm font-medium text-foreground uppercase">
                      {user?.document_type || "Cédula de Ciudadanía"}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3 p-3 rounded-lg border border-border/40 bg-muted/15">
                  ...
                  <div className="space-y-0.5">
                    ...
                    <p className="text-sm font-medium text-foreground font-mono">
                      {user?.document_number || "No digitalizado"}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex gap-3 items-start p-3.5 rounded-xl border border-amber-500/20 bg-amber-500/2 text-amber-800 dark:text-amber-300">
                ...
                <div className="text-xs space-y-1">
                  <span className="font-semibold">
                    Nota de Cumplimiento Técnico:
                  </span>
                  <p className="text-muted-foreground leading-relaxed">
                    Tu usuario está configurado para estampar tu nombre e
                    identificación en el snapshot de las órdenes de entrada
                    generadas.
                  </p>
                </div>
              </div>
        ...
        <div className="space-y-6">
          <Card className="border-border/60 shadow-xs overflow-hidden h-full">
            ...
            <CardHeader className="pb-4">
              ...
              <CardDescription>
                Sede y entorno multi-inquilino asignado.
              </CardDescription>
            </CardHeader>
              ...
              <div className="flex flex-col items-center text-center p-4 border border-dashed rounded-xl bg-muted/5 gap-3">
                ...
                <div>
                  <h3 className="text-sm font-semibold text-foreground tracking-tight">
                    {tenantData?.name || "Nombre del CDA"}
                  </h3>
                  <p className="text-[11px] font-mono text-muted-foreground mt-0.5">
                    {tenantData?.id || "ID-TENANT"}
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between text-xs py-1">
                  ...
                  <span className="font-semibold text-foreground tracking-tight">
                    {tenantData?.domain || "No configurado"}
                  </span>
                </div>
                ...
                <div className="flex items-center justify-between text-xs py-1">
                  ...
                  <Badge
                    variant="outline"
                    className="text-[10px] font-semibold border-emerald-500/30 text-emerald-600 bg-emerald-500/5 tracking-wide"
                  >
                    ISO 17020
                  </Badge>
                </div>
      ...
      {/* EL GRID SE CIERRA AQUÍ AHORA, LIBERANDO A LA FIRMA */}
      ...
      <Card className="border-border/60 shadow-xs overflow-hidden bg-background">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="space-y-0.5">
                ...
                <p className="text-xs text-muted-foreground max-w-2xl leading-relaxed">
                  Esta firma digitalizada será incrustada de forma automática en
                  todas las órdenes de entrada para dar cumplimiento a la
                  trazabilidad de la norma ISO 17020.
                </p>
              </div>
            </div>
          ...
          <div className="max-w-5xl m-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
            ...
            <div className="max-w-130 w-full m-auto space-y-3">
              ...
              <p className="text-[10px] text-center text-muted-foreground/60 font-medium tracking-wide">
                La firma se guardará con un fondo blanco sólido óptimo para la
                generación de PDFs de órdenes de entrada.
              </p>
            </div>
            ...
            <div className="max-w-130 w-full m-auto space-y-3">
              ...
              <p className="text-[10px] text-center text-muted-foreground/60 font-medium tracking-wide">
                Esta es la representación digital que se incrustará bajo la
                norma ISO 17020.
              </p>
            </div>
          </div>
        ...
        >
          <CheckCircle2
            className={`size-4 ${isUpdating ? "animate-spin" : "animate-pulse"}`}
          />
