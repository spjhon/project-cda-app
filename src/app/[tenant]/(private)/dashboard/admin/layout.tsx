...
export default function AdminDashboardLayout({
  ...
  const initialPQAFPromise: Promise<PQAFListItem[]> = (async () => {
    ...
    const { data, error } = await supabaseServer.rpc(
      "fetch_service_requirements_list",
      {
        ...
        p_fecha_desde: undefined,
        p_fecha_hasta: undefined,
    ...
    if (error) {
      console.error(
        "❌ Error en RPC fetch_service_requirements_list inicial:",
        error.message,
      );
      return [];
    }
  ...
  return (
    ...
    <AdminLoaderContext
      ...
      adminAnalyticsDiaryPromise={adminAnalyticsDiaryPromise}
      initialPQAFPromise={initialPQAFPromise}
    >
