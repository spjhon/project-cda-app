...
export default function FullmotosLandingPage({
  currentTenant,
}: {
  ...
  return (
    <>
          ...
          <div className="flex flex-col items-center md:items-start space-y-6 max-w-2xl w-full md:w-[60%] text-center md:text-left">
            ...
            <div className="flex flex-col space-y-4">
              ...
              <p className="text-lg md:text-xl font-normal text-[#003554]/90 dark:text-white/80">
                Revisión técnico mecánica y de emisiones contaminantes exclusivo
                para motocicletas en la ciudad de Manizales.
              </p>
            </div>
        ...
        <div className="max-w-6xl w-full flex flex-col md:flex-row gap-12 items-center justify-between">
          ...
          <div className="w-full md:w-[55%] rounded-xl border border-[#006494]/20 dark:border-[#00a6fb]/30 bg-white dark:bg-[#051923] text-[#051923] dark:text-white shadow-md p-8 md:p-10 flex flex-col space-y-6">
            ...
            <div className="text-base md:text-lg font-normal text-[#003554]/90 dark:text-white/80 leading-relaxed space-y-4">
              <p>
                Desde el año 2022, nos hemos consolidado en la ciudad de
                Manizales como el Centro de Diagnóstico Automotor líder y
                exclusivo para motocicletas de 2 y 4 tiempos. Nacimos bajo la
                firme premisa de proteger la vida en las vías, transformando la
                revisión técnico-mecánica en un pilar fundamental para la
                seguridad vial de nuestra región.
              </p>
              <p>
                Con más de{" "}
                <strong className="text-[#051923] dark:text-white font-bold">
                  20,000 revisiones exitosas
                </strong>
                , nuestra trayectoria es sinónimo de categoría, respaldo y
                confianza. Nos enfocamos rigurosamente en la calidad técnica y
                el estado óptimo de cada vehículo, garantizando que ruede con
                total tranquilidad por calles y carreteras.
              </p>
              <p>
            ...
            <div className="pt-4 border-t border-[#006494]/10 dark:border-[#00a6fb]/20 flex items-center gap-4 text-sm font-semibold text-[#003554]/70 dark:text-white/60">
              <div className="flex items-center gap-1.5">
                <span className="text-[#00a6fb] text-lg">✓</span> Acreditados
                ONAC
              </div>
              <div className="w-1.5 h-1.5 rounded-full bg-[#006494]/30 dark:bg-[#00a6fb]/30"></div>
              <div className="flex items-center gap-1.5">
                <span className="text-[#00a6fb] text-lg">✓</span> Manizales,
                Caldas
              </div>
            </div>
          </div>
      ...
      <section
        id="servicios"
        className="w-full flex items-center justify-center bg-[#00a6fb]/5 dark:bg-[#051923]/40 px-6 py-16 md:px-12 select-none transition-colors duration-300"
      >
              ...
              <div className="flex flex-col space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm font-normal text-[#003554]/80 dark:text-white/70 leading-relaxed">
                    ...
                    avalado por la ONAC. Diseñado con pistas exclusivas para
                    motocicletas de 2 y 4 tiempos, garantizando agilidad y
                    precisión.
                  </p>
                </div>
              </div>
      ...
      >
        <div className="max-w-5xl w-full flex flex-col space-y-10">
          ...
          <div className="flex flex-col space-y-3 text-center items-center">
            ...
            <p className="text-base md:text-lg font-normal text-[#003554]/80 dark:text-white/70 max-w-2xl">
              Conoce las 5 etapas reglamentarias que realizamos en nuestra pista
              especializada para garantizar el estado óptimo de tu motocicleta.
            </p>
          </div>
      ...
      <section
        id="preparacionRTM"
        className="w-full flex flex-col items-center justify-center bg-[#00a6fb]/5 dark:bg-[#051923]/40 px-6 py-16 md:px-12 select-none transition-colors duration-300"
      >
        <div className="max-w-6xl w-full flex flex-col space-y-12">
          {/* Encabezado */}
          <div className="flex flex-col space-y-3 text-center items-center">
                ...
                <div className="flex flex-col space-y-6">
                  ...
                  {tarifa.esSoat && tarifa.desgloseSoat && (
                    <div className="flex flex-col space-y-2.5 bg-[#006494]/5 dark:bg-white/5 p-4 rounded-xl border border-[#006494]/10 dark:border-white/10">
                      <span className="text-xs font-bold uppercase tracking-wider text-[#003554] dark:text-[#00a6fb]">
                      ...
                      <div className="flex flex-col space-y-1.5">
                        {tarifa.desgloseSoat.map((item, idx) => (
                          ...
                          >
                            <span className="text-[#003554]/80 dark:text-white/70">
                              {item.rango}
                            </span>
                            <span className="font-bold text-[#051923] dark:text-white">
                              {item.valor}
                            </span>
                          </div>
                        ))}
                  ...
                  <CardContent className="p-0">
                    <ul className="flex flex-col space-y-3">
                      {tarifa.detalles.map((detalle, idx) => (
                        <li
                          key={idx}
                          className="flex items-start text-sm text-[#003554]/90 dark:text-white/80 font-normal"
                        >
                          <span className="text-[#00a6fb] mr-2.5 font-bold">
                            ✓
                          </span>
                          {detalle}
                        </li>
      ...
      >
        <div className="max-w-5xl w-full flex flex-col space-y-12">
          ...
          <div className="flex flex-col space-y-3 text-center items-center">
            ...
            <p className="text-base md:text-lg font-normal text-[#003554]/80 dark:text-white/70 max-w-2xl">
              Visítanos en nuestra sede en Manizales o comunícate con nosotros
              para resolver cualquier inquietud sobre la revisión de tu
              motocicleta.
            </p>
          </div>
              ...
              <div className="flex flex-col space-y-6">
                ...
                <div className="flex flex-col space-y-4">
                  ...
                  <div className="flex items-start gap-3 text-sm font-normal text-[#003554]/90 dark:text-white/80">
                    ...
                    <div>
                      <p className="font-bold text-[#051923] dark:text-white">
                        Dirección de la Sede
                      </p>
                      <p className="mt-0.5">
                        Cra. 25 #17-66, Manizales, Caldas
                      </p>
                    </div>
                  </div>
              ...
              <div className="flex flex-col space-y-6">
                ...
                <div className="flex flex-col space-y-3">
                  ...
                  <div className="flex justify-between items-center py-2.5 text-sm">
                    <span className="font-bold text-[#003554]/60 dark:text-white/40">
                      Domingos y Festivos
                    </span>
                ...
                <p className="text-xs font-normal text-[#003554]/70 dark:text-white/60 bg-[#006494]/5 dark:bg-white/5 p-4 rounded-xl border border-[#006494]/10 dark:border-white/10 leading-relaxed">
                  ...
                  motocicleta a las líneas de diagnóstico técnico-mecánico. El
                  cierre de la pista se realiza puntualmente.
                </p>
              </div>
            </div>
          </div>
                  ...
                  {faq.tieneLista && faq.itemsLista && (
                    <div className="mt-3 flex flex-col space-y-2">
                      {faq.itemsLista.map((item, index) => (
                        <p key={index}>
                          •{" "}
                          <strong className="text-[#051923] dark:text-white">
                            {item.titulo}:
                          </strong>{" "}
                          A los{" "}
                          <strong className="text-[#006494] dark:text-[#00a6fb]">
        ...
        <div className="max-w-6xl w-full flex flex-col space-y-12">
          ...
          <div className="w-full flex justify-center px-4 md:px-10">
            ...
            >
              ...
              <CarouselPrevious
                disabled={false}
                className="flex left-[-30] sm:-left-12  border-[#006494]/20 dark:border-[#00a6fb]/30 bg-white dark:bg-[#051923] text-[#051923] dark:text-[#00a6fb] hover:bg-[#00a6fb]/10"
              />
              <CarouselNext
                disabled={false}
                className="flex right-[-30] sm:-right-12 border-[#006494]/20 dark:border-[#00a6fb]/30 bg-white dark:bg-[#051923] text-[#051923] dark:text-[#00a6fb] hover:bg-[#00a6fb]/10"
              />
            </Carousel>
          </div>
        </div>
      ...
      <section
        id="CTA"
        className="w-full flex items-center justify-center bg-[#00a6fb]/5 dark:bg-[#051923]/40 px-6 py-20 md:px-12 select-none transition-colors duration-300"
      >
      ...
      >
        <div className="max-w-5xl w-full flex flex-col space-y-12">
          ...
          <div className="flex flex-col space-y-3 text-center items-center">
            ...
            <p className="text-base md:text-lg font-normal text-[#003554]/80 dark:text-white/70 max-w-2xl">
              En el CDA Fullmotos la 25 trabajamos bajo la norma ISO 17020 para
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
            {tramites.map((item, index) => (
              <Card
                key={index}
                className="border border-[#006494]/10 dark:border-[#00a6fb]/20 bg-white dark:bg-[#051923] shadow-sm rounded-2xl overflow-hidden"
              >
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row justify-between gap-10 py-12">
          ...
          <div className="flex flex-col max-w-md space-y-4">
            ...
            <p className="text-sm font-normal text-[#003554]/70 dark:text-white/60 leading-relaxed">
              ...
              Contaminantes para motocicletas 2 y 4 tiempos en Manizales.
              Comprometidos con tu seguridad vial.
            </p>

            <div className="space-y-1.5 text-sm text-[#003554]/80 dark:text-white/70">
              <p>
                <span className="font-bold text-[#051923] dark:text-[#00a6fb]">
                  Dirección:
                </span>{" "}
                Calle 25, Manizales, Caldas
              </p>
              <p>
                <span className="font-bold text-[#051923] dark:text-[#00a6fb]">
                  Celular / WhatsApp:
